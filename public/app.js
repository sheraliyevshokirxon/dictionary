...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _updateU__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./updateU */ \"./src/js/updateU.js\");\n\r\n\r\nfunction errorUI(error) {\r\n    const box = document.querySelector(\".box\")\r\n    box.innerHTML =\"\"\r\n    console.log(error[0]);\r\n    const container = document.querySelector('.box')\r\n    const { title, message, resolution } = error\r\n    box.innerHTML = `\r\n    <div class=\"error\">\r\n    <p class=\"sad\">😕</p>\r\n    <h2 class=\"error__title\">${error.title}</h2>\r\n    <p class=\"error__desc\">${error.message + error.resolution}</p>\r\n    </div>\r\n    `;\r\n}\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (errorUI);\n\n//# sourceURL=webpack://1-project/./src/js/error.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _request__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./request */ \"./src/js/request.js\");\n/* harmony import */ var _updateU__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./updateU */ \"./src/js/updateU.js\");\n/* harmony import */ var _error__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./error */ \"./src/js/error.js\");\n\r\n\r\n\r\n\r\nconst input = document.getElementById(\"input\")\r\nconst form = document.querySelector(\".form\")\r\n\r\nform.addEventListener(\"submit\", (e) =>{\r\n    e.preventDefault()\r\n\r\n    const query = input.value;\r\n    input.value = ''\r\n    const API = `https://api.dictionaryapi.dev/api/v2/entries/en/${query}`\r\n    \r\n    ;(0,_request__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(API).then((data) =>{\r\n        ;(0,_updateU__WEBPACK_IMPORTED_MODULE_1__.meiningSpik)(data)\r\n        console.log(data);\r\n    }).catch((err) =>{\r\n        (0,_error__WEBPACK_IMPORTED_MODULE_2__[\"default\"])(err)\r\n    })\r\n    \r\n})\r\n\n\n//# sourceURL=webpack://1-project/./src/js/search.js?");
